...
| [Xiaomi MiMo Token Plan](https://platform.xiaomimimo.com/token-plan) | Public plans list 0.8× usage from 00:00–08:00 UTC+8 for the displayed Max, Pro, and Standard tiers, alongside plan-specific credit amounts. This is plan economics, not a universal service-capacity guarantee. | Collect the public Token Plan page and MiMo documentation; never treat plan credits as a visitor’s remaining quota. |
